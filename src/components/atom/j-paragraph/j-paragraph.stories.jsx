...
import { TEXT_ALIGN_MAP, TEXT_ALIGN_VALUES, TEXT_SIZE } from '../../../utils/constants.js';
...
export default {
  ...
  argTypes: {
    ...
    textSize: {
      ...
      mapping: Object.keys(TEXT_SIZE),
      description: 'Size of the text for paragraph element',
    },
  },
  args: {
